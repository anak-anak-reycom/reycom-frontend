...
export default function FillPeripheral () {
    return (
      <div className='mx-auto max-w-[1000px] my-8 p-4'>
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl'>Scanner</h1>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl'>Printer</h1>
                <p className='mt-8 text-[16px] '>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl'>Projector</h1>
                <p className='mt-8 text-[16px] '>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl'>E-KTP Reader</h1>
                <p className='mt-8 text-[16px] '>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl'>Video Conference System</h1>
                <p className='mt-8 text-[16px] '>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl'>Interactive Panel</h1>
                <p className='mt-8 text-[16px] '>
