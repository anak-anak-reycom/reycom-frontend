...
export default function FillPeripheral () {
    return (
      <div className='mx-auto max-w-[1000px] my-8 p-4'>
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl font-sans'>Scanner</h1>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl font-sans'>Printer</h1>
                <p className='mt-8 text-[16px] font-sans'>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl font-sans'>Projector</h1>
                <p className='mt-8 text-[16px] font-sans'>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl font-sans'>E-KTP Reader</h1>
                <p className='mt-8 text-[16px] font-sans '>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl font-sans'>Video Conference System</h1>
                <p className='mt-8 text-[16px] font-sans'>
        ...
        <div className='mt-8'>
            <h1 className='text-start font-bold text-4xl font-sans'>Interactive Panel</h1>
                <p className='mt-8 text-[16px]  font-sans'>
