// components/admin/jobList/jobList.tsx (AdminJobCard)
"use client";
      ...
      <div className="bg-white rounded-md p-5 shadow-md hover:shadow-lg transition-shadow duration-200 h-full flex flex-col">
        <div className="flex items-start gap-4 border-b border-gray-100 pb-4">
          ...
          <div className="flex-1">
            ...
            {career.category?.nameCategory && (
              <div className="text-sm text-gray-500 mt-1">{career.category.nameCategory}</div>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 p-4">
          <button
            type="button"
            onClick={() => onEdit?.(career.id)} // ← panggil callback, bukan router.push
