    ...
    <>
      <div className='mx-auto max-w-[1400px] grid grid-cols-2 p-4'>
        ...
        <div>
          ...
          <div className="mt-10"> <div className="grid grid-cols-2 gap-4 max-w-[420px] mx-auto md:mx-0"> 
            <div className="flex items-center justify-center gap-3 px-5 py-2 border-2 rounded-full border-[#214B62]"> <Timer size={18} /> 
            <span className="text-sm font-medium">Full Time</span> 
            </div> 
            <div className="flex items-center justify-center gap-3 px-5 py-2 border-2 rounded-full border-[#214B62]"> <Calendar size={18} />
          ...
          <div className="mt-6 flex justify-center md:justify-start">
            <button
              ...
              className="px-6 py-2 text-sm font-medium rounded-full border-2 border-[#214B62] min-w-[140px] text-black bg-white hover:bg-[#214B62] hover:text-white transition"
            >
              Apply Now
            </button>
          </div>
      ...
      <AnimatePresence>
        {showApply && (
          ...
          >
            {/* Modal Card */}
            <motion.div
              className="relative bg-white w-full max-w-2xl rounded-3xl shadow-2xl p-6 max-h-[90vh] overflow-y-auto"
